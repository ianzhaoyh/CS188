...
class CornersProblem(search.SearchProblem):
    ...
    def isGoalState(self, state: Any):
        ...
        """
        "*** YOUR CODE HERE ***"
        return (state[1]==0 and state[2]==0 and state[3]==0 and state[4]==0)
        util.raiseNotDefined()
    ...
    def getSuccessors(self, state: Any):
        ...
        a,b,c,d=state[1],state[2],state[3],state[4]
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
           ...
           if not self.walls[nextx][nexty]:
            ...
            for i,corner in enumerate(self.corners):
                if newPos==corner:
                    ...
                    if i==2: new3=0
                    if i==3: new4=0
            nextState=(newPos,new1,new2,new3,new4)
...
def cornersHeuristic(state: Any, problem: CornersProblem):
    ...
    current_pos=state[0]
    unvisited_corner=[corners[i] for i in range(len(corners)) if corner_bool[i]==1]
...
class FoodSearchProblem:
    ...
    def getSuccessors(self, state):
        ...
        for direction in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            nextx, nexty = int(x + dx), int(y + dy)
            if not self.walls[nextx][nexty]:
                nextFood = state[1].copy() #grid可变，所以先copy一个下来
